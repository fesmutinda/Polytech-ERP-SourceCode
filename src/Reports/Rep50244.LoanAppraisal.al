...
Report 50244 "Loan Appraisal"
{
    ...
    dataset
    {
        dataitem("Loans Register"; "Loans Register")
        {
            ...
            column(deposits_Recovered; "Loans Register"."M-Polytech Recoveries") { }
            ...
            begin
                ...
                if LoanType.Get("Loan Product Type") then begin
                    ...
                    MPolytechRecoveries := "Loans Register"."M-Polytech Recoveries";
                    // LoanInsurance := ROUND(SFactory.FnGetChargeFee("Loans Register"."Loan Product Type", "Loans Register"."Approved Amount", 'LAP'), 1, '=');

                    Upfronts := LoanProcessingFee + LAppraisalFee + LegalFee + DisbursementFee + "Deboost Commision" + "Deboost Amount" + ValuationFee + TopUpFee + TopUpComm + MPolytechRecoveries + BRIGEDAMOUNT;
