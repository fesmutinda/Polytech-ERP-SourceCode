Report 56890 "Wallet Account Statement"
{
    DefaultLayout = RDLC;
    // RDLCLayout = './Layouts/Wallet Account Statement.rdlc';
    RDLCLayout = './Layouts/Wallet Account Statement 2026.rdlc';
    ...
    var
        ...
        All_amounts_are_in_LCYCaptionLbl: label 'All amounts are in Ksh';
