...
Report 56519 "Insider Loans Employee"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Insider Loans Employee.rdlc';

    dataset
    {
        dataitem("Loans Register"; "Loans Register")
        {
            DataItemTableView = where("Outstanding Balance" = filter(> 0), "Insider-Employee" = filter(true));
