...
Report 56858 "Loans Register-Net"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        ...
        {
            // DataItemTableView = where(Posted = const(true)) sorting("Loan  No.") order(ascending);
            DataItemTableView =
                                SORTING("Loan  No.")
                                ORDER(Ascending);
            // where("Outstanding Balance" = filter(> 0));
            // WHERE(Posted = CONST(true));
            PrintOnlyIfDetail = false;
            RequestFilterFields = "Loan Disbursement Date", "Loan Product Type", "Outstanding Balance", "Client Code", "Date filter";
            ...
            column(CompanyLetter_Head; CompanyInfo."Address 2")
            {
            }
            ...
            begin
                //I have added this to auto update the balances every loop
            ...
            begin
                ...
                "Loans Register".SetAutoCalcFields("Outstanding Balance");
    ...
    var
        ...
        // "general set-up": Record 51516381;
        Days: Integer;
        EndMonthInt: Decimal;
        BRIDGEBAL2: Decimal;
        DefaultInfo: Text[80];
        ...
        // BANDING: Record 51516402;
        NtTakeHome: Decimal;
        ATHIRD: Decimal;
        Psalary: Decimal;
        // LoanApss: Record 51516371;
        TotalLoanBal: Decimal;
        TotalBand: Decimal;
        // LoanAp: Record 51516371;
        TotalRepay: Decimal;
        TotalInt: Decimal;
        LastFieldNo: Integer;
        TotLoans: Decimal;
