...
Report 56873 "ANNEX 3 - MEMBER Deposits"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ANNEX 3 - MEMBER Deposits.rdlc';

    dataset
    {
        dataitem(Customer; Customer)
        {
            // DataItemTableView = where("Current Shares" = filter(> 0));//, Status = const(Active));
            PrintOnlyIfDetail = false;
            RequestFilterFields = "No.", "Employer Code", "Personal No", "Current Shares", "Date Filter";
            ...
            column(CurrentShares_MembersRegister; Customer."Current Shares")// NonRe")
            {
            }
            ...
            begin
                ...
                // Customer.CalcFields("Current Shares-NonRe");
                EntryNo := EntryNo + 1;
            end;
    ...
    begin
        ...
        // custLedgEntry.SetFilter("Date Filter", Customer."Date Filter");
    end;
    ...
    var
        ...
        RPeriod: Decimal;
        BatchL: Code[100];
        // Batches: Record UnknownRecord51516377;
