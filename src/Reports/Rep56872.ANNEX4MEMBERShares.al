...
Report 56872 "ANNEX 4 - MEMBER Shares"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ANNEX 4 - MEMBER Shares.rdlc';

    dataset
    {
        dataitem(Customer; Customer)
        {
            // DataItemTableView = where("Shares Retained" = filter(<> 0), Status = const(Active));
            // DataItemTableView = where("Shares Retained" = filter(> 0));
            PrintOnlyIfDetail = false;
            RequestFilterFields = "No.", "Employer Code", "Personal No", "Shares Retained", "Date Filter";
            ...
            column(MemberShareClass_MembersRegister; Customer."Member Share Class")
            {
            }
    ...
    begin
        ...
        // CustLedEntries.SetFilter("Date Filter", memberRegister."Date Filter");
    end;
    ...
    var
        ...
        BOSABal: Decimal;
        SuperBal: Decimal;
        // LAppl: Record UnknownRecord51516371;
        Deposits: Decimal;
        CompanyCode: Code[20];
        LoanType: Text[50];
        // LoanProdType: Record UnknownRecord51516381;
        LCount: Integer;
        RFilters: Text[250];
        DValue: Record "Dimension Value";
        // VALREPAY: Record UnknownRecord51516365;
        ...
        // CustRecord: Record UnknownRecord51516364;
        TShares: Decimal;
        TLoans: Decimal;
        ...
        Linterest1: Integer;
        LOANBALANCE: Decimal;
        // BRIDGEDLOANS: Record UnknownRecord51516376;
        BRIDGEBAL: Decimal;
        ...
        // "general set-up": Record UnknownRecord51516398;
        Days: Integer;
        EndMonthInt: Decimal;
        BRIDGEBAL2: Decimal;
        DefaultInfo: Text[80];
        ...
        // BANDING: Record UnknownRecord51516402;
        NtTakeHome: Decimal;
        ATHIRD: Decimal;
        Psalary: Decimal;
        // LoanApss: Record UnknownRecord51516371;
        TotalLoanBal: Decimal;
        TotalBand: Decimal;
        // LoanAp: Record UnknownRecord51516371;
        TotalRepay: Decimal;
        TotalInt: Decimal;
        LastFieldNo: Integer;
        TotLoans: Decimal;
        ...
        // Loantop: Record UnknownRecord51516376;
