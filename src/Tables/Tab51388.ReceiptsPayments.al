...
Table 51388 "Receipts & Payments"
{
    ...
    fields
    {
        ...
        {
            OptionCaption = 'Deposit Contribution,Jikoe Savings,Holiday Savings,Unallocated Funds';
            OptionMembers = "Deposit Contribution","Jikoe Savings","Holiday Savings","Unallocated Funds";
        }
    }
