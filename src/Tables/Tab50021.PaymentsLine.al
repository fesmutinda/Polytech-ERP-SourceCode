...
Table 50021 "Payments Line"//new one from Nav - Depricated
{
    // DrillDownPageID = UnknownPage51516146;
    // LookupPageID = UnknownPage51516146;
    ...
    fields
    {
        ...
        field(3; Type; Code[20])
        {
            ...
            begin
                ...
                if RecPayTypes.Find('-') then begin
                    "Default Grouping" := RecPayTypes."Default Grouping";
                ...
                if recpt.Find('-') then begin
                    if recpt."Default Grouping" = 'Polytech' then begin
        ...
        field(24; "Withholding Tax Code"; Code[20])
        {
            ...
            begin
                ...
                ObjFundsTaxCodes.SetRange(ObjFundsTaxCodes."Tax Code", "Withholding Tax Code");
                if ObjFundsTaxCodes.Find('-') then begin
                    "Withholding Tax Amount" := Amount * (ObjFundsTaxCodes.Percentage / 100);
        ...
        field(124; "VAT Amount"; Decimal)
        {
            ...
            begin
                ...
                "Net Amount" := Amount - ("VAT Amount" + "Withholding Tax Amount" + "Refund Charge");
                if "Currency Code" <> '' then begin
                    "VAT Amount(LCY)" := ROUND(CurrExchRate.ExchangeAmtFCYToLCY(Date, "Currency Code", "VAT Amount", "Currency Factor"));
                    "Net Amount(LCY)" := ROUND(CurrExchRate.ExchangeAmtFCYToLCY(Date, "Currency Code", "Net Amount", "Currency Factor"));
                end else begin
        ...
        field(26; "Withholding Tax Amount"; Decimal)
        {
            ...
            begin
                ...
                if "Currency Code" <> '' then begin
                    "W/TAX Amount(LCY)" := ROUND(CurrExchRate.ExchangeAmtFCYToLCY(Date, "Currency Code", "Withholding Tax Amount", "Currency Factor"));
                    "Net Amount(LCY)" := ROUND(CurrExchRate.ExchangeAmtFCYToLCY(Date, "Currency Code", "Net Amount", "Currency Factor"));
                end else begin
