...
{
    DrillDownPageID = "Payment Line New";
    LookupPageID = "Payment Line New";
    ...
    fields
    {
        ...
        field(13; "Account No."; Code[20])
        {
            ...
            else if ("Account Type" = const(Vendor)) Vendor where("Account Type" = filter('<>M-Wallet'))
        ...
        field(87222222; "Applies-to Doc. No. fake"; Code[20])
        {
        ...
        field(87; "Applies-to Doc. No."; Code[20])
        {
            ...
            TableRelation = "Purch. Inv. Header"."No."
                            where("Buy-from Vendor No." = field("Account No."));
            ...
            begin
                ...
                PurchInvHeader.SetRange("Buy-from Vendor No.", Rec."Account No.");

                if Page.RunModal(Page::"Posted Purchase Invoices", PurchInvHeader) = Action::LookupOK then begin
                    Rec.Validate("Applies-to Doc. No.", PurchInvHeader."No.");
