...
Table 51113 "Payment Line"
{
    ...
    fields
    {
        ...
        {
            TableRelation = if ("Transaction Type" = const("Loan Repayment")) "Loans Register"."Loan  No." where("Client Code" = field("Account No."));
        }
        field(50002; "Transaction Type"; enum TransactionTypesEnum) //Option)
        {
