...
Table 51516113 "Payment Line"
{
    ...
    fields
    {
            ...
            begin
                ...
                if PLine.Get(No) then begin
                    if Type = 'Member' then begin
                        ...
                        end else if PLine."Pay Mode" = PLine."pay mode"::Mpesa then begin
        ...
        {
            DataClassification = ToBeClassified;
            TableRelation = "Member Register"."No." where("Member Type" = filter(Board));

            trigger OnValidate()
            begin
                // Paymentline.RESET;
                // //Paymentline.SETRANGE(Paymentline.No,Paymentline.No);
