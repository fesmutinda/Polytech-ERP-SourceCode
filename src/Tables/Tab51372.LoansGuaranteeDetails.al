    ...
    fields
    {
        ...
        field(11; "Amont Guaranteed"; Decimal)
        {
            ...
            begin
                ...
                if (memberMaximumAbility < "Amont Guaranteed") and not "Self Guarantee" then begin
