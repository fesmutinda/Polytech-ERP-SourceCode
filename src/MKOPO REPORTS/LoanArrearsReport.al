...
//                 DataItemTableView = sorting("Loan  No.") where(Posted = const(true), "Loan Product Type" = filter(<> '24'));
...
//                         repeat
//                             LoansR."Amount in Arrears" := LoanArrears;
//                             //LoansR."Schedule Repayment" := ScheduleBalance;
//                             LoansR.Modify();
//                             commit;
//                         until LoansR.Next() = 0;
//                     end;
...
//                     DefaultNotices.Reset();
//                     DefaultNotices.SetRange("Loan In Default", Loans."Loan  No.");
//                     if DefaultNotices.Find('-') then begin
//                         DefaultNotices."Amount in Arrears" := LoanArrears;
