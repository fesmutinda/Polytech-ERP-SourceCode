...
Report 51045 "monthly exp polytech"
{
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            column(MemberInsurance; memberInsurance) { }
            ...
            begin
                ...
                TOTALREMMITANCE := 0;
                TOTALREMMITANCE := montlycon + memberInsurance + "Welfare Contr" + ShareCapital + NORMALLOAN1i + NORMALLOANp + NORMALLOANi + NORMALLOAN1p + EMERGENCYp + EMERGENCYi + SUPEREMERGENCYp + SUPEREMERGENCYi + QUICKLOANp + QUICKLOANi + SUPERQUICKp + SUPERQUICKi + SCHOOLFEESp + SCHOOLFEESi + SUPERSCHOOLFEESp + SUPERSCHOOLFEESi +
        ...
        layout
        {
            area(Content)
            {
                field(Date; ASAT)
                {
                    ...
                    Caption = 'Last Date of the Month';
                }
            }
        }
