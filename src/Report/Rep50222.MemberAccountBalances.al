...
Report 50222 "Member Account  Balances"
{
    ...
    dataset
    {
        dataitem(member; "Member Register")
        {
            ...
            column(Shares_capital; Member."Shares Retained")// "Share Capital")
            {
            }
            ...
            begin
                ...
                CalcFields("Current Shares", "Shares Retained", "Outstanding Balance", "Outstanding Interest", "holiday Contribution");
                LoansBal := "Outstanding Balance";
                CurrentShares := "Current Shares";
                SharesCap := "Shares Retained";
