...
Codeunit 99000810 "Calculate Planning Route Line"
{
    ...
    local procedure GetSendAheadStartingTime(PlanningRoutingLine2: Record "Planning Routing Line";FirstLine: Boolean;var SendAheadLotSize: Decimal): Boolean
    var
    ...
    local procedure GetSendAheadEndingTime(PlanningRoutingLine2: Record "Planning Routing Line";FirstLine: Boolean;var SendAheadLotSize: Decimal): Boolean
    var
        ExpectedTime: Decimal;
    ...
    local procedure FindSendAheadEndingTime(var TmpPlanRtngLine: Record "Planning Routing Line";var TmpProdOrderCapNeed: Record "Prod. Order Capacity Need";var SendAheadLotSize: Decimal): Boolean
    var
        Result: Boolean;
    ...
    local procedure FindSendAheadStartingTime(var TmpPlanRtngLine: Record "Planning Routing Line";var TmpProdOrderCapNeed: Record "Prod. Order Capacity Need";var SendAheadLotSize: Decimal): Boolean
    var
        Result: Boolean;
        xTotalLotSize: Decimal;
        xSendAheadLotSize: Decimal;
