...
Codeunit 53908 "HR Leave Jnl.-Post Linee"
{
    ...
    var
        ...
        InsCoverageLedgEntry2: Record 51516383;
        ...
        NextEntryNo: Integer;
        TempJnlLineDim: Record 51516256;
        TempJnlLineDim2: Record 51516256;


    procedure RunWithCheck(var InsuranceJnlLine2: Record 51516384;TempJnlLineDim2: Record 51516256)
    begin
    ...
    procedure RunWithOutCheck(var InsuranceJnlLine2: Record 51516384;TempJnlLineDim: Record 51516256)
    begin
        InsuranceJnlLine.Copy(InsuranceJnlLine2);
