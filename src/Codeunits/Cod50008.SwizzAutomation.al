...
Codeunit 50008 SwizzAutomation
{
    ...
    local procedure FnGenerateNewSavingsTransaction(ObjFD: Record 51435; RollBackAmount: Decimal; PreviousPostingDate: Date)
    var
        ObjNewFD: Record 51435;
    begin
        ObjNewFD.Init;
