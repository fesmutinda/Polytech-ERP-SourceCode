...
Codeunit 99000838 "Prod. Order Comp.-Reserve"
{
    ...
    procedure CreateReservation(ProdOrderComp: Record "Prod. Order Component";Description: Text[50];ExpectedReceiptDate: Date;Quantity: Decimal;QuantityBase: Decimal;ForSerialNo: Code[50];ForLotNo: Code[50])
    var
        ShipmentDate: Date;
    begin
    ...
    local procedure CreateBindingReservation(ProdOrderComp: Record "Prod. Order Component";Description: Text[50];ExpectedReceiptDate: Date;Quantity: Decimal;QuantityBase: Decimal)
    begin
