...
Codeunit 53907 "HR Leave Jnl.-Check Linee"
{
    ...
    var
        ...
        LeaveEntries: Record 51516383;
        Text004: label 'The Allocation of Leave days has been done for the period';


    procedure ValidatePostingDate(var InsuranceJnlLine: Record 51516384)
    begin
    ...
    procedure RunCheck(var InsuranceJnlLine: Record 51516384;var JnlLineDim: Record 51516256)
    var
