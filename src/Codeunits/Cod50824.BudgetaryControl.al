...
Codeunit 50824 "Budgetary Control"
{
    ...
    procedure CheckPaymentsPettyCash(var PaymentHeader: Record 51000)
    var
        PayLine: Record "Payment Line";
    ...
    procedure CheckImprest(var ImprestHeader: Record 51006)
    var
        PayLine: Record 51007;
        Commitments: Record 51036;
        Amount: Decimal;
        GLAcc: Record "G/L Account";
        Item: Record Item;
    ...
    procedure CheckStaffClaim(var ImprestHeader: Record 51010)
    var
    ...
    procedure CheckStaffAdvance(var ImprestHeader: Record 51006)
    var
        PayLine: Record 51007;
        Commitments: Record 51036;
        Amount: Decimal;
    ...
    procedure CheckStaffAdvSurr(var ImprestHeader: Record 51497)
    var
        PayLine: Record 51498;
        Commitments: Record 51440;
        Amount: Decimal;
        GLAcc: Record "G/L Account";
        Item: Record Item;
        FirstDay: Date;
    ...
    procedure CheckGrantSurr(var GrantHeader: Record 51219)
    var
        GrantLine: Record 51220;
        Commitments: Record 51440;
        Amount: Decimal;
        GLAcc: Record "G/L Account";
        Item: Record Item;
