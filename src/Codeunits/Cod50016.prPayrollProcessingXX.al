...
Codeunit 50016 prPayrollProcessingXX
{
    ...
    var
        ...
        DaysWorked: Integer;
        prSalaryArrears: Record 51164;
        prEmployeeTransactions: Record 51267;
        prTransactionCodes: Record 51340;
        ...
        prEmployerDeductions: Record 51342;
    ...
    var
        ...
        startmonth: Integer;
        startYear: Integer;
        "prEmployee P9 Info": Record 51339;
        P9BasicPay: Decimal;
        P9taxablePay: Decimal;
        P9PAYE: Decimal;
