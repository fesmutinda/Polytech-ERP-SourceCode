...
Codeunit 51516018 "Match Bank Rec. Lines H"
{
    ...
    procedure MatchManually2(var SelectedBankAccReconciliationLine: Record 51516012; var SelectedBankAccountLedgerEntry: Record "Bank Account Ledger Entry")
    var
    ...
    procedure RemoveMatch2(var SelectedBankAccReconciliationLine: Record 51516012; var SelectedBankAccountLedgerEntry: Record "Bank Account Ledger Entry")
    var
        BankAccReconciliationLine: Record 51516012;
        BankAccountLedgerEntry: Record "Bank Account Ledger Entry";
        BankAccEntrySetReconNo: Codeunit "Bank Acc. Entry Set Recon.-No.";
