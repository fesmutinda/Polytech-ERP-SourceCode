...
Codeunit 99000778 OrderTrackingManagement
{
    ...
    procedure FindRecord(Which: Text[250];var TrackingEntry2: Record "Order Tracking Entry"): Boolean
    begin
    ...
    procedure GetNextRecord(Steps: Integer;var TrackingEntry2: Record "Order Tracking Entry") CurrentSteps: Integer
    begin
        TrackingEntry := TrackingEntry2;
    ...
    local procedure InsertTrackingEntry(var ReservEntry: Record "Reservation Entry";var ReservEntry2: Record "Reservation Entry";Level: Integer)
    begin
    ...
    local procedure TrackingEntryExists(): Boolean
    var
        TrackingEntry2: Record "Order Tracking Entry";
    begin
        TrackingEntry2 := TrackingEntry;
