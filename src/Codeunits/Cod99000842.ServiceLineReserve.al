...
Codeunit 99000842 "Service Line-Reserve"
{
    ...
    procedure CreateReservation(ServiceLine: Record "Service Line";Description: Text[50];ExpectedReceiptDate: Date;Quantity: Decimal;QuantityBase: Decimal;ForSerialNo: Code[50];ForLotNo: Code[50])
    var
        ShipmentDate: Date;
    begin
    ...
    local procedure CreateBindingReservation(ServiceLine: Record "Service Line";Description: Text[50];ExpectedReceiptDate: Date;Quantity: Decimal;QuantityBase: Decimal)
    begin
