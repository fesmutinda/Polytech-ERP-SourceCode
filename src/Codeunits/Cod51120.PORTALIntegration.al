...
Codeunit 51120 PORTALIntegration
{
    ...
    begin
        ...
        if objMember.FindFirst() then begin
            ...
            OutputText += '"InsuranceContribution":"' + Format(ROUND(InsuranceContribution, 0.01)) + '",';
    ...
    procedure fnWalletStatement(MemberNo: Code[50]; "filter": Text; var BigText: BigText) exitString: Text
    var
        Filename: Text[100];
        Outputstream: OutStream;
        RecRef: RecordRef;
    ...
    begin
        ...
        if Vendor.Find('-') then begin
            ...
            TempBlob.CreateOutStream(Outstr);
            TempBlob.CreateInStream(Instr);
            if Report.SaveAs(Report::"Wallet Account Statement", '', ReportFormat::Pdf, Outstr, RecRef) then begin
                exitString := Base64Convert.ToBase64(Instr);
                exit;
            end;
        end;
    ...
    procedure fndividentstatement(MemberNo: Code[50]) exitString: Text
    var
        Filename: Text[100];
        Outputstream: OutStream;
        RecRef: RecordRef;
    ...
    begin
        ...
        if objMember.Find('-') then begin
            ...
            TempBlob.CreateOutStream(Outstr);
            TempBlob.CreateInStream(Instr);
            if Report.SaveAs(Report::"Members Dividend Statement", '', ReportFormat::Pdf, Outstr, RecRef) then begin
                exitString := Base64Convert.ToBase64(Instr);
                exit;
            end;
        end;
