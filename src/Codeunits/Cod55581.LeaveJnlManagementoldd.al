...
Codeunit 55581 LeaveJnlManagementoldd
{
    ...
    procedure TemplateSelection(FormID: Integer; var InsuranceJnlLine: Record 51516384; var JnlSelected: Boolean)
    var
    ...
    procedure TemplateSelectionFromBatch(var InsuranceJnlBatch: Record 51516344)
    var
    ...
    procedure OpenJournal(var CurrentJnlBatchName: Code[10]; var InsuranceJnlLine: Record 51516384)
    begin
    ...
    procedure OpenJnlBatch(var InsuranceJnlBatch: Record 51516344)
    var
        InsuranceJnlTemplate: Record 51516343;
        InsuranceJnlLine: Record 51516384;
        JnlSelected: Boolean;
    begin
    ...
    procedure CheckName(CurrentJnlBatchName: Code[10]; var InsuranceJnlLine: Record 51516384)
    var
    ...
    procedure SetName(CurrentJnlBatchName: Code[10]; var InsuranceJnlLine: Record 51516384)
    begin
        InsuranceJnlLine.FilterGroup := 2;
        InsuranceJnlLine.SetRange(Cycle, CurrentJnlBatchName);
        InsuranceJnlLine.FilterGroup := 0;
    ...
    procedure LookupName(var CurrentJnlBatchName: Code[10]; var InsuranceJnlLine: Record 51516384): Boolean
    var
        InsuranceJnlBatch: Record 51516344;
    begin
        Commit;
    ...
    procedure GetDescriptions(InsuranceJnlLine: Record 51516384; var InsuranceDescription: Text[30]; var FADescription: Text[30])
    var
        Insurance: Record 51516339;
        FA: Record 51516316;
    begin
