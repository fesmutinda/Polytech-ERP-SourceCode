...
Codeunit 53912 "Job-JnlManagementt"
{
    ...
    var
        ...
        LastJobJnlLine: Record 53917;
        OpenFromBatch: Boolean;


    procedure TemplateSelection(FormID: Integer; RecurringJnl: Boolean; var JobJnlLine: Record 53917; var JnlSelected: Boolean)
    var
    ...
    procedure TemplateSelectionFromBatch(var JobJnlBatch: Record 53922)
    var
    ...
    procedure OpenJnl(var CurrentJnlBatchName: Code[10]; var JobJnlLine: Record 53917)
    begin
    ...
    procedure OpenJnlBatch(var JobJnlBatch: Record 53922)
    var
        JobJnlTemplate: Record 53916;
        JobJnlLine: Record 53917;
        JobJnlBatch2: Record 53922;
        JnlSelected: Boolean;
    begin
    ...
    procedure CheckName(CurrentJnlBatchName: Code[10]; var JobJnlLine: Record 53917)
    var
        JobJnlBatch: Record 53922;
    begin
    ...
    procedure SetName(var CurrentJnlBatchName: Code[10]; var JobJnlLine: Record 53917)
    begin
        JobJnlLine.FilterGroup := 2;
        JobJnlLine.SetRange("Journal Batch Name", CurrentJnlBatchName);
        JobJnlLine.FilterGroup := 0;
    ...
    procedure LookupName(var CurrentJnlBatchName: Code[10]; var JobJnlLine: Record 53917): Boolean
    var
        JobJnlBatch: Record 53922;
    begin
        Commit;
    ...
    procedure GetNames(var JobJnlLine: Record 53917; var JobDescription: Text[50]; var AccName: Text[50])
    var
        Job: Record 53913;
        Res: Record Resource;
        Item: Record Item;
