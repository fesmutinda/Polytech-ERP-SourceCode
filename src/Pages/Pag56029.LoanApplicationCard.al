...
Page 56029 "Loan Application Card"
{
                ...
                action("Notify Guarantors")
                {
                    ...
                    begin
                        ...
                        if Rec."Notify Guarantor SMS" = true then begin
                            if Confirm('Guarantor(s) already notified. Notify them Again?', false) = false then begin
    ...
    begin
        LoanAppPermisions();
        RecoveriesStyle := Rec."M-Polytech Recoveries" > 0;
    end;
    ...
    procedure getLoansDeducted()
    var
        amountDeducted: Decimal;
    begin

        //Get the M-Polytech Recovered
        Rec."M-Polytech Recoveries" := 0;

        //update amountDeducted
        Rec."M-Polytech Recoveries" := swizzMobile.getMpolytechAmountDeducted(Rec."Client Code");
        ;//  ROUND(amountDeducted, 1, '=');
    end;
