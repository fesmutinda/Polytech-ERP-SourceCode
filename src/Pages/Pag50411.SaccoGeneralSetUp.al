    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    Caption = 'Auto Open M-Wallets Accounts';
                    ApplicationArea = Basic;
                }
                field("Package Retrieval Charge"; Rec."Package Retrieval Charge") { }
                field("Package Retrieval Charge Acc"; Rec."Package Retrieval Charge Acc") { }
            }
