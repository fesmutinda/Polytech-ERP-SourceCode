...
Page 51516924 "Lead card"
{
    ...
    var
        ...
        PvApp: Record UnknownRecord51516365;
        ...
        Asother: Boolean;
        Ascase: Boolean;
        Leadacc: Record UnknownRecord51516555;
        LeadAcc2: Record UnknownRecord51516555;
        ok: Boolean;
        LeadSetup: Record UnknownRecord51516558;
        LeadNo: Code[20];
        NoSeriesMgt: Codeunit NoSeriesManagement;
        CaseNO: Code[20];
        CaseSetup: Record UnknownRecord51516558;
        sure: Boolean;
        Yah: Boolean;
