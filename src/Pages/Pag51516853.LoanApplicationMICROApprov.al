...
Page 51516853 "Loan Application MICRO(Approv)"
{
    ...
    local procedure FnDisburseToCurrentAccount(LoanApps: Record UnknownRecord51516371)
    var
    ...
    local procedure FnBoosterLoansDisbursement(ObjLoanDetails: Record UnknownRecord51516371; LineNo: Integer): Code[40]
    var
        GenJournalLine: Record "Gen. Journal Line";
