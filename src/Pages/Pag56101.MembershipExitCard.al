...
Page 56101 "Membership Exit Card"
{
    DeleteAllowed = true;
    Editable = true;
    InsertAllowed = true;
                ...
                action("Post Membership Exit")
                {
                    ...
                    begin
                        ...
                        /* case Rec."Closure Type" of
                            ...
                            //Message('Member No is %1', Rec."Member No.");
    ...
    begin
        GenSetUp.Get;
        //Message('Member No Code Gets here is %1', Rec."Member No.");
        IF Cust.Get(MemberNo) then begin
            if Confirm('Proceed With Account Closure ?', false) = false then begin
                ...
                //Message('Member  Rec."Paying Bank" is %1', Rec."Paying Bank");
            end;

        end;

        //Message('Running Bal Here Cust2 is %1', RunningBal);
        //............................Post Lines
        GenJournalLine.RESET;
        GenJournalLine.SETRANGE("Journal Template Name", TemplateName);
        GenJournalLine.SETRANGE("Journal Batch Name", BatchName);
