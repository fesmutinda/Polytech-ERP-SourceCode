...
Page 51516909 "Loan Disb Batch Card(MICRO)"
{
    ...
    var
        ...
        HisaLoan: Record UnknownRecord51516371;
        ...
        ProductCharges: Record UnknownRecord51516383;
        InsuranceAcc: Code[20];
        PTEN: Code[20];
        LoanTypes: Record UnknownRecord51516381;
        Customer: Record UnknownRecord51516364;
        DataSheet: Record UnknownRecord51516417;
        SMSAcc: Code[10];
        SMSFee: Decimal;
